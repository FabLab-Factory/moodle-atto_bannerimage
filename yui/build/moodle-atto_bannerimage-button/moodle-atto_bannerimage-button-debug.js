YUI.add('moodle-atto_bannerimage-button', function (Y, NAME) {
...
/**
 * @module moodle-atto_bannerimage-button
 */

/**
 * Atto text editor tutorials plugin.
 *
 * @namespace M.atto_bannerimage
 * @class button
...
var CSS = {
  ...
  INPUTALIGNMENT: 'atto_bannerimage_alignment',
  INPUTALT: 'atto_bannerimage_altentry',
  INPUTHEIGHT: 'atto_bannerimage_heightentry',
  INPUTSUBMIT: 'atto_bannerimage_urlentrysubmit',
  INPUTURL: 'atto_bannerimage_urlentry',
  ...
  IMAGEPREVIEW: 'atto_bannerimage_preview',
  IMAGEPREVIEWBOX: 'atto_bannerimage_preview_box',
  ALIGNSETTINGS: 'atto_bannerimage_button'
},
SELECTORS = {
...
Y.namespace('M.atto_bannerimage').Button = Y.Base.create('button', Y.M.editor_atto.EditorPlugin, [], {
/**
...
_getAlignmentPropeties: function(image, properties) {
  ...
  complete = ALIGNMENTS.some(function(alignment) {
      ...
      if (image.hasClass(classname)) {
          ...
          Y.log('Found alignment ' + alignment.value, 'debug', 'atto_bannerimage-button');
...
_removeLegacyAlignment: function(imageNode) {
  ...
  ALIGNMENTS.some(function(alignment) {
      ...
      Y.log('Legacy alignment found and removed.', 'info', 'atto_bannerimage-button');
