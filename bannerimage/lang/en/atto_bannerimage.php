...
/**
 * Strings for component 'atto_bannerimage', language 'en'.
 *
...
$string['pluginname'] = 'FabLib banner image';
...
$string['width'] = 'Width';
$string['privacy:metadata'] = 'The atto_bannerimage plugin does not store any personal data.';
